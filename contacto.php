...
?> 
    ...
    <main class="contenedor">
        ...
        <picture>
            ...
            <img loading="lazy" src="build/img/destacada3.jpg" alt="imagen de formulario">
        </picture>
        ...
        <form class="formulario" action="">
            ...
            <fieldset>
                ...
                <textarea id="mensaje" placeholder="Tu mensaje...">
                </textarea>
            ...
            <fieldset>
                ...
                <p>Si eligió telefono, elija la fecha y hora para ser contactado</p>
                    ...
                    <input name="hora" type="time" value="hora" id="hora" min="09:00" max="18:00">
